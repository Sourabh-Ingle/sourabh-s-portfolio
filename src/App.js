     ...
     {/* FOR LAPTOP VIEW 1ST DIV */}
      <div className="first-div">
        ...
        <div className="name">
            ...
            <img src="img/sourabh.png" alt="" className="myImg" />
           

          <h3 className="myname">SOURABH INGLE</h3>

          <h5 className='name-designation'>WEB DEVELOPER</h5>

          <a href='./Resume/sourabhResume.pdf' targrt='_bank' download='SourabhCv.pdf' className="cvDownload">Download</a>
      ...
      <div className="second-div">
        <div className="edu-workinfo" id='Education'>
          ...
          <button className="btn" onClick={() => setEduOrWork(false)}>Work</button>
          {
            eduOrWork ? <Education /> : <Work />
          }
        </div>
